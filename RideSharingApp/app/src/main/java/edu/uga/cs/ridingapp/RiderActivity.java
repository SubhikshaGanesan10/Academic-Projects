...
public class RiderActivity extends AppCompatActivity {
    ...
    private Button viewMyRideRequests;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewMyRideRequests = findViewById(R.id.button12);
        ...
        viewMyRideRequests.setOnClickListener(new ViewMyRideRequestsButtonClickListener());
    }

    private class ViewMyRideRequestsButtonClickListener implements View.OnClickListener {
        @Override
