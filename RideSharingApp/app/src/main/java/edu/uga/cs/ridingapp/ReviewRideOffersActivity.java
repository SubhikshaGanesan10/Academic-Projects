...
//        });
        ...
        // "onlyMine" is set when a driver opens this screen from their own "My Ride Offers"
        // button, to review/update/delete their own unaccepted ride offers.
        ...
        if (onlyMine) {
            ...
            query = myRef.orderByChild("driverName").equalTo(currentUserEmail);
        }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                noDataTextView.setVisibility(rideOffersList.isEmpty() ? View.VISIBLE : View.GONE);
            }
