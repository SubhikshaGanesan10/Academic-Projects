    ...
    private void retrieveDonations() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Log.e("ViewPostedDonations", "Failed to load donations: " + databaseError.getMessage());
                Toast.makeText(ViewPostedDonations.this, "Failed to load donations: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                noDataTextView.setVisibility(View.VISIBLE);
            }
        });
    }
