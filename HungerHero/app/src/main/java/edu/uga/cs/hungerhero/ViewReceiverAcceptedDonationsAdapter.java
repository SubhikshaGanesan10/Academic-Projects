...
public class ViewReceiverAcceptedDonationsAdapter extends RecyclerView.Adapter<ViewReceiverAcceptedDonationsAdapter.AcceptedDonationViewHolder> {
    ...
    private void removeDonationFromDatabase(AcceptedDonationItem acceptedDonationItem) {
        // The "donor's accepted donations list" path stores a flat list of entries,
        // each carrying its own donorUserId field, so query on that flat list directly.
        Query donationQuery = donorAcceptedDonationsRef
        ...
        donationQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (item.getDonorUserId().equals(acceptedDonationItem.getDonorUserId())
                            && item.getReceiverUserId().equals(acceptedDonationItem.getReceiverUserId())) {
