    ...
    private void retrieveAcceptedDonations() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Log.e("ViewReceiverAcceptedDonations", "Failed to load accepted donations: " + databaseError.getMessage());
                Toast.makeText(ViewReceiverAcceptedDonations.this, "Failed to load accepted donations: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                noDataTextView.setVisibility(View.VISIBLE);
            }
        });
    }
